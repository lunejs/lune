...
type Documents = {
    ...
    "\n  query CountDiscounts {\n    discounts {\n      count\n    }\n  }\n": typeof types.CountDiscountsDocument,
...
const documents: Documents = {
    ...
    "\n  mutation RemoveAssetsMutation($ids: [ID!]!) {\n    removeAssets(ids: $ids)\n  }\n": types.RemoveAssetsMutationDocument,
    ...
    "\n  fragment CommonCustomFieldDefinitionForOptionValues on CustomFieldDefinition {\n    id\n    createdAt\n    updatedAt\n    name\n    key\n    isList\n    appliesToEntity\n    type\n    metadata\n    order\n    referenceTarget {\n      id\n      createdAt\n      updatedAt\n      name\n      key\n      entries {\n        items {\n          id\n          createdAt\n          updatedAt\n          slug\n          values {\n            id\n            value\n            translations {\n              id\n              value\n              locale\n            }\n            field {\n              id\n              name\n              key\n              type\n              isList\n            }\n          }\n        }\n      }\n      displayField {\n        id\n        createdAt\n        updatedAt\n        name\n        key\n        isList\n        appliesToEntity\n        type\n        metadata\n        order\n      }\n      fields {\n        id\n        createdAt\n        updatedAt\n        name\n        key\n        isList\n        appliesToEntity\n        type\n        metadata\n        order\n      }\n    }\n  }\n": types.CommonCustomFieldDefinitionForOptionValuesFragmentDoc,
    ...
    "\n  query GetCustomFieldDefinitionsForOptionValues($input: CustomFieldDefinitionListInput) {\n    customFieldDefinitions(input: $input) {\n      count\n      pageInfo {\n        total\n      }\n      items {\n        ...CommonCustomFieldDefinitionForOptionValues\n      }\n    }\n  }\n": types.GetCustomFieldDefinitionsForOptionValuesDocument,
    ...
    "\n  mutation AddCustomObjectEntryTranslation(\n    $id: ID!\n    $input: addCustomObjectEntryTranslationInput!\n  ) {\n    addCustomObjectEntryTranslation(id: $id, input: $input) {\n      id\n    }\n  }\n": types.AddCustomObjectEntryTranslationDocument,
    "\n  query GetCustomObjectEntriesCount($definitionId: ID!) {\n    customObjectEntries(definitionId: $definitionId, input: { take: 1 }) {\n      count\n    }\n  }\n": types.GetCustomObjectEntriesCountDocument,
    ...
    "\n  query GetTotalOrder($input: MetricInput!) {\n    totalOrders(input: $input) {\n      total\n      metrics {\n        key\n        value\n      }\n    }\n  }\n": types.GetTotalOrderDocument,
    "\n  query GetTotalNewCustomer($input: MetricInput!) {\n    totalNewCustomers(input: $input) {\n      total\n      metrics {\n        key\n        value\n      }\n    }\n  }\n": types.GetTotalNewCustomerDocument,
    "\n  query GetTotalAvgOrderValue($input: MetricInput!) {\n    totalAverageOrdersValue(input: $input) {\n      total\n      metrics {\n        key\n        value\n      }\n    }\n  }\n": types.GetTotalAvgOrderValueDocument,
    ...
    "\n  mutation MarkFulfillmentAsShipped($fulfillmentId: ID!, $input: MarkFulfillmentAsShippedInput!) {\n    markFulfillmentAsShipped(fulfillmentId: $fulfillmentId, input: $input) {\n      apiErrors {\n        code\n        message\n      }\n      order {\n        id\n      }\n    }\n  }\n": types.MarkFulfillmentAsShippedDocument,
    "\n  mutation MarkFulfillmentAsReadyForPickup($fulfillmentId: ID!) {\n    markFulfillmentAsReadyForPickup(fulfillmentId: $fulfillmentId) {\n      apiErrors {\n        code\n        message\n      }\n      order {\n        id\n      }\n    }\n  }\n": types.MarkFulfillmentAsReadyForPickupDocument,
    "\n  mutation MarkFulfillmentAsDelivered($fulfillmentId: ID!) {\n    markFulfillmentAsDelivered(fulfillmentId: $fulfillmentId) {\n      apiErrors {\n        code\n        message\n      }\n      order {\n        id\n      }\n    }\n  }\n": types.MarkFulfillmentAsDeliveredDocument,
    "\n  mutation MarkFulfillmentAsPickedUp($fulfillmentId: ID!) {\n    markFulfillmentAsPickedUp(fulfillmentId: $fulfillmentId) {\n      apiErrors {\n        code\n        message\n      }\n      order {\n        id\n      }\n    }\n  }\n": types.MarkFulfillmentAsPickedUpDocument,
