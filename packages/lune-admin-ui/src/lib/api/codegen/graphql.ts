...
export type GetCustomObjectEntryQuery = { customObjectEntry?: { id: string, createdAt: any, updatedAt: any, slug: string, values: Array<{ id: string, value: any, field: { id: string, name: string, key: string, type: CustomFieldType } }> } | null };
