...
export type CommonOrderFragment = { id: string, code?: string | null, state: OrderState, total: number, subtotal: number, totalQuantity: number, placedAt?: any | null, customer?: { id: string, firstName?: string | null, lastName?: string | null, email: string } | null, lines: { count: number }, fulfillment?: { __typename: 'Fulfillment' } | null } & { ' $fragmentName'?: 'CommonOrderFragment' };
...
export type GetAllOrdersQuery = { orders: { count: number, pageInfo: { total: number }, items: Array<{ ' $fragmentRefs'?: { 'CommonOrderFragment': CommonOrderFragment } }> } };
