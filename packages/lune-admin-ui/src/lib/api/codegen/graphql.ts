...
export type CommonDiscountFragment = { id: string, code: string, applicationMode: DiscountApplicationMode, applicationLevel: DiscountApplicationLevel, startsAt: any, endsAt?: any | null, enabled: boolean, handler: { code: string, args: any } } & { ' $fragmentName'?: 'CommonDiscountFragment' };
