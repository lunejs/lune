...
export type CommonCustomObjectDefinitionFragment = { id: string, createdAt: any, updatedAt: any, name: string, key: string, displayFieldId?: string | null } & { ' $fragmentName'?: 'CommonCustomObjectDefinitionFragment' };
