...
export const LocationConstants = {
  ...
  SecondLocationID: TestHelper.generateUUID()
};
...
export class LocationFixtures implements Fixture<LocationTable> {
  ...
  async build(): Promise<Partial<LocationTable>[]> {
    return [
      ...
      {
        id: LocationConstants.SecondLocationID,
        name: 'Brooklyn Store',
        street_line_1: '5th avenue',
        street_line_2: 'Floor 3',
        city: 'New York',
        postal_code: '07087',
        phone_number: '13125552047',
        references: 'Secondary store',
        country_id: CountryConstants.UsID,
        state_id: StateConstants.UsNewYorkID,
        shop_id: ShopConstants.ID
      }
