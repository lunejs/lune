...
export const ProductConstants = {
  ...
  Slug: 'product-with-custom-fields',
  Name: 'Product with custom fields',

  WithoutFieldsID: TestUtils.generateUUID(),
  WithoutFieldsSlug: 'product-without-custom-fields',
  ...
  async build(): Promise<Partial<ProductTable>[]> {
    return [
      ...
      },
      {
        ...
        slug: ProductConstants.WithoutFieldsSlug,
        name: 'Product without custom fields',
        shop_id: ShopConstants.ID
      },
      {
