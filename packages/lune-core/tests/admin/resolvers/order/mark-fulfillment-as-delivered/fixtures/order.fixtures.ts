...
export const OrderConstants = {
  ShippedFulfillmentOrderID: TestUtils.generateUUID(),
  PickupOrderID: TestUtils.generateUUID(),
  PendingFulfillmentOrderID: TestUtils.generateUUID()
};
    ...
    return [
      {
        ...
        id: OrderConstants.ShippedFulfillmentOrderID,
      ...
      {
        shop_id: ShopConstants.ID,
        id: OrderConstants.PickupOrderID,
        state: OrderState.PartiallyFulfilled,
        code: '#002',
        total: 5000,
        subtotal: 5000,
      ...
      {
        shop_id: ShopConstants.ID,
        id: OrderConstants.PendingFulfillmentOrderID,
        state: OrderState.PartiallyFulfilled,
        code: '#003',
        total: 5000,
        subtotal: 5000,
