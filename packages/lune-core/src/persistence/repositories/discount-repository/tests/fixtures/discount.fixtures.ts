    ...
    return [
      {
        ...
        enabled: true,
        combinable: true,
        handler: { type: 'percentage', value: 10 },
      ...
      },
      {
        ...
        enabled: true,
        combinable: true,
        handler: { type: 'percentage', value: 20 },
        shop_id: ShopConstants.ID
      },
      {
        ...
        enabled: true,
        combinable: true,
        handler: { type: 'percentage', value: 15 },
        shop_id: ShopConstants.ID
      },
      {
        ...
        enabled: true,
        combinable: true,
        handler: { type: 'percentage', value: 5 },
        shop_id: ShopConstants.ID
      },
      {
        ...
        enabled: false,
        combinable: true,
        handler: { type: 'percentage', value: 25 },
        shop_id: ShopConstants.ID
      },
      {
