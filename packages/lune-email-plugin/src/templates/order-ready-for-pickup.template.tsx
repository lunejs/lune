          ...
          <Container className="mx-auto max-w-[500px] w-full">
            <EmailHeader>
              ...
              <EmailHeaderTitle className="mt-0">
                {getFullName(clean(order.customer))}, your order is ready for pickup
              </EmailHeaderTitle>
              <EmailHeaderSubtitle>{instructions}</EmailHeaderSubtitle>
...
export const createOrderReadyForPickupEmail = (input: Props) => render(<Component {...input} />);
