...
const Component = ({ shop, order }: Props) => {
  const shippingDetails = order.fulfillmentDetails as ShippingFulfillment;
          ...
          <Container className="mx-auto max-w-[500px] w-full">
            <EmailHeader>
              ...
              <EmailHeaderTitle className="mt-0">
                {getFullName(clean(order.customer))}, your order is on the way
              </EmailHeaderTitle>
              <EmailHeaderSubtitle>
...
export const createOrderShippedEmail = (input: Props) => render(<Component {...input} />);
